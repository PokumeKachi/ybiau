...
<svg viewBox="0 0 200 200">
  <style>
    ...
    circle { fill: red; }
    text { fill: white; font-size: 16px; }
  </style>

  <polygon points="50,150 50,50 150,150"/>
  <circle cx="50" cy="150" r="4"/>
  <circle cx="50" cy="50" r="4"/>
  <circle cx="150" cy="150" r="4"/>
  <text x="45" y="175">A</text>
  <text x="45" y="40">B</text>
  <text x="155" y="175">C</text>
</svg>

<iframe
    src="https://www.desmos.com/calculator/jkyqwxbwwg?fontSize=10"
    width="100%"
    height="500">
</iframe>
